...
def upgrade() -> None:
    ...
    with op.batch_alter_table("storage_uploads", schema=None) as batch_op:
        batch_op.create_index(batch_op.f("ix_storage_uploads_created"), ["created"], unique=False)
        batch_op.create_index(batch_op.f("ix_storage_uploads_item_id"), ["item_id"], unique=False)
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("storage_uploads", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_storage_uploads_item_id"))
        batch_op.drop_index(batch_op.f("ix_storage_uploads_created"))
