...
export default {
  ...
  'Enter the code shown on your device.': 'Introduzca el código que aparece en su dispositivo.',
  ...
  'Files kept on a WebDAV server are not stored at zotero.org, so a migration cannot bring them across. Keep syncing files through WebDAV, or upload them from a Zotero client that still holds them.':
    'Los archivos guardados en un servidor WebDAV no están almacenados en zotero.org, así que una migración no puede traerlos. Sigue sincronizando los archivos por WebDAV, o súbelos desde un cliente de Zotero que todavía los tenga.',
  'Finished.': 'Terminado.',
  ...
  'That request has expired or does not exist. Start the sign-in again in Zotero.': 'Esa solicitud ha caducado o no existe. Vuelva a iniciar sesión desde Zotero.',
  ...
  'You can go back to your device now.': 'Ya puede volver a su dispositivo.',
