/** French. Keys are the English text; see `locales/en-US.ts`. */
...
export default {
  ...
  'A passkey signs you in on its own — your device checks it is you, and there is no password to steal.': 'Une clé d’accès vous connecte à elle seule : votre appareil vérifie que c’est bien vous, et il n’y a pas de mot de passe à voler.',
  ...
  'Add a SAML provider': 'Ajouter un fournisseur SAML',
  'Add a passkey': 'Ajouter une clé d’accès',
  'Add a provider': 'Ajouter un fournisseur',
  'Add an OpenID Connect provider': 'Ajouter un fournisseur OpenID Connect',
  ...
  'Add, change and remove things in your library': 'Ajouter, modifier et supprimer des éléments de votre bibliothèque',
  ...
  'Change the group libraries you belong to': 'Modifier les bibliothèques de groupe dont vous êtes membre',
  ...
  'Download your attachments': 'Télécharger vos pièces jointes',
  ...
  'Enter the code shown on your device.': 'Saisissez le code affiché sur votre appareil.',
  ...
  'Files kept on a WebDAV server are not stored at zotero.org, so a migration cannot bring them across. Keep syncing files through WebDAV, or upload them from a Zotero client that still holds them.':
    'Les fichiers conservés sur un serveur WebDAV ne sont pas stockés chez zotero.org ; une migration ne peut donc pas les apporter. Continuez à synchroniser les fichiers par WebDAV, ou envoyez-les depuis un client Zotero qui les a encore.',
  'Finished.': 'Terminé.',
  ...
  Invite: 'Inviter',
  'Issuer': 'Émetteur',
  'It cannot read your library, your notes or your attachments.': 'Elle ne peut lire ni votre bibliothèque, ni vos notes, ni vos pièces jointes.',
  ...
  Name: 'Nom',
  'Name for a new passkey': 'Nom d’une nouvelle clé d’accès',
  'Name on the button': 'Nom sur le bouton',
  'Name saved.': 'Nom enregistré.',
  'Needed to add or remove one.': 'Nécessaire pour en ajouter ou en supprimer une.',
  ...
  'Other applications you have allowed to reach this account. Each was given only the permissions you approved.': 'Les autres applications que vous avez autorisées à accéder à ce compte. Chacune n’a reçu que les autorisations que vous avez accordées.',
  'Overview': 'Vue d’ensemble',
  'PEM. Paste both while the provider is rolling its key over.': 'PEM. Collez les deux pendant que le fournisseur change de clé.',
  ...
  'Provider entity ID': 'Identifiant d’entité du fournisseur',
  ...
  'Read everything in your library': 'Lire tout ce qui se trouve dans votre bibliothèque',
  'Read only': 'Lecture seule',
  'Read the group libraries you belong to': 'Lire les bibliothèques de groupe dont vous êtes membre',
  'Read your notes': 'Lire vos notes',
  ...
  'So you can tell it apart later — “Work laptop”, “Yubikey”.': 'Pour la reconnaître plus tard : « Portable du travail », « Yubikey ».',
  ...
  'Taking you back to the application…': 'Retour à l’application…',
  ...
  'That link is missing its request.': 'Il manque la demande à ce lien.',
  ...
  'That passkey was removed.': 'Cette clé d’accès a été supprimée.',
  ...
  'That request has expired or does not exist. Start the sign-in again in Zotero.': 'Cette demande a expiré ou n’existe pas. Recommencez la connexion depuis Zotero.',
  'That request has expired or was never started. Start again in the application.': 'Cette demande a expiré ou n’a jamais été faite. Recommencez depuis l’application.',
  ...
  'This server’s entity ID is its own public URL.': 'L’identifiant d’entité de ce serveur est sa propre URL publique.',
  ...
  'Use a passkey instead': 'Utiliser plutôt une clé d’accès',
  ...
  'What its assertions carry as Issuer.': 'Ce que ses assertions portent comme Issuer.',
  ...
  'You can disconnect it at any time in Settings, under Connected applications.': 'Vous pouvez la déconnecter à tout moment dans les réglages, sous « Applications connectées ».',
  'You can go back to your device now.': 'Vous pouvez revenir à votre appareil.',
  ...
  'wants to connect to your account': 'souhaite se connecter à votre compte',
  ...
  '“{name}” was disconnected and stops working immediately.': '« {name} » a été déconnectée et cesse de fonctionner immédiatement.',
  '“{name}” was revoked and stops working immediately.':
    '« {name} » a été révoquée et cesse de fonctionner immédiatement.',
  'Know who you are': 'Savoir qui vous êtes',
}
