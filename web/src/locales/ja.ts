...
export default {
  ...
  'Choose at least one library or collection, or allow everything above.':
    'ライブラリまたはコレクションを少なくとも 1 つ選ぶか、上のすべてを許可してください。',
  ...
  'Choosing a collection also includes everything nested inside it. The application will not be able to change your collections, saved searches, settings or tags.':
    'コレクションを選ぶと、その中に入れ子になっているものもすべて含まれます。アプリケーションはコレクション、保存された検索、設定、タグを変更できません。',
  Citation: '引用',
  ...
  'Everything the permissions above cover': '上の権限が及ぶすべて',
  Expand: '展開',
  ...
  'Last time you limited it to:': '前回は次の範囲に限定しました：',
  ...
  'Only the libraries and collections I choose': '自分で選んだライブラリとコレクションだけ',
