...
export default {
  ...
  'Attachments and notes': '添付ファイルとノート',
  ...
  'Group {id}': 'グループ {id}',
  'Include group libraries': 'グループライブラリを含める',
  Invitations: '招待',
  'Items in {name}': '{name} のアイテム',
  ...
  '{count} item | {count} items': '{count} 件 | {count} 件',
